          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            {user && (
              <>
                ...
                <Link to="/orders" style={{ textDecoration: 'none', color: '#67442E' }}>
            ...
            {user?.role === 'admin' && (
              <Link to="/admin/dashboard" style={{ textDecoration: 'none', color: '#67442E' }}>
                Admin Dashboard
              </Link>
            )}
            {user ? (
              <>
                {user.isSeller && user.storeName && (
                  <Typography sx={{ color: '#67442E', mr: 1 }}>
                    {user.storeName}
                  </Typography>
                )}
